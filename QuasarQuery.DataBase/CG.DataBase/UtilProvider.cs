...
namespace OraDeveloperNet.Core
{
    public class UtilProvider
    {
        public static DbType ConvertDataType(string pDataType)
        {
            ...
            EnumProviders pProvider = ApplicationFow.CurrentConect.Provider;

            if (pProvider == EnumProviders.SQLServer)
            {
                switch (pDataType)
                {
                    case "varchar":
            ...
            else if (pProvider == EnumProviders.Oracle)
            {
                switch (pDataType)
                {
        ...
        public static string SerializerDataType(string pDataType, EnumProviders pProvider)
        {
