...
namespace QuasarQuery.Controls
{
	/// <summary>
	/// A textbox the does syntax highlighting.
	/// </summary>
    public class TextQuery : System.Windows.Forms.RichTextBox 
	{
		#region Members
...
//			System.Diagnostics.Debug.WriteLine(sb.ToString());
        ...
        protected override void OnDragDrop(DragEventArgs drgevent)
        {
            ...
            this.SelectedText = drgevent.Data.GetData(DataFormats.Text).ToString();
        }
